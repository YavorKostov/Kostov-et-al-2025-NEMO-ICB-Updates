...
CONTAINS
   ...
   SUBROUTINE icb_init( pdt, kt )
      ...
      !
      numsubsteps     = 4
      berg_dt         = NINT(pdt/numsubsteps)
      numsubsteps     = NINT(pdt/berg_dt)
      ...
      DO jj = nicbdj, nicbej
         DO ji = nicbdi, nicbei
            IF( tmask(ji,jj,1) > 0._wp        .AND.                                       &
               ...
               localpt%uvel = 0._wp
               localpt%vvel = 0._wp
!               localpt%uvel = 0.1_wp ! 0._wp  !-0.05_wp !SQRT(2.0_wp)/(20._wp)
!               localpt%vvel = 0.1_wp ! 0._wp  ! -SQRT(2.0_wp)/(20._wp)
               localpt%kb   = 1
               localpt%zdrag_groundedx_stored = 0._wp 
               localpt%zdrag_groundedy_stored = 0._wp
               localpt%zdrag_groundedxG_stored = 0._wp 
               localpt%zdrag_groundedyG_stored = 0._wp
               localpt%zdrag_groundedxS_stored = 0._wp
               localpt%zdrag_groundedyS_stored = 0._wp               
               localpt%Xdrag_ocn_stored = 0._wp
               localpt%Xdrag_atm_stored = 0._wp
               localpt%Xdrag_ice_stored = 0._wp
               localpt%Xgrad_press_sc_stored = 0._wp
               localpt%Xdrag_Cori_stored = 0._wp
               localpt%Ydrag_ocn_stored = 0._wp
               localpt%Ydrag_atm_stored = 0._wp
               localpt%Ydrag_ice_stored = 0._wp
               localpt%Ygrad_press_sc_stored = 0._wp
               localpt%Ydrag_Cori_stored = 0._wp
               localpt%zaxe_stored = 0._wp 
               localpt%zaye_stored = 0._wp
               localpt%zaxeBeforeFG_stored = 0._wp 
               localpt%zayeBeforeFG_stored = 0._wp
               localpt%zFequil = 0._wp 
               localpt%zFdisequil = 0._wp
               localpt%angleTopoXlagr = 0._wp 
               localpt%angleTopoYlagr = 0._wp 
               localpt%angleTopolagr = 0._wp
               localpt%ibathy_x1y1 = 0._wp 
               localpt%issh_x1y1 = 0._wp
               CALL icb_utl_incr()
